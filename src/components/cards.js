...
const Card = ({ data }) => {
    const { Title, Aim, Model, btn_data, image } = data;
    ...
    return (
        ...
        >
            ...
            <Link to="/strokeform" className=" mt-10 relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-black border-2 border-[#77d5ca] rounded-full hover:text-white group hover:bg-[#77d5ca]">
