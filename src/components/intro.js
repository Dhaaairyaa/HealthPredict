            ...
            <div style={backgroundImageStyle} className="h-auto flex flex-col items-center justify-center">
                ...
                <div className="flex flex-row w-full">
                    ...
                    <div className="w-1/2 text-black mt-48">
                        ...
                        <a href="#" target="blank" className=" mt-10 relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-black border-2 border-[#77d5ca] rounded-full hover:text-white group hover:bg-[#77d5ca]">
